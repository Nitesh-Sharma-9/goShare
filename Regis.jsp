...
<style>
  ...
  <body class="bgc" >
      ...
      <form action="RegisAct"  method="post" class ="container" style="margin-top: 150px; font-size: 10px" >
        <pre><h3>
        <%
        ...
        Conform Password:<input type="password" name="cps" />
                          ...
                          <input type="button" value="New Captcha"/> <img name="catpcha" src="" height="70" width="200"><br>                                            
